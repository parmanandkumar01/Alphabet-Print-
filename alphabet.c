...
/* Error happen
Global Variables: In C, global or static variables must be initialized with compile-time constants.

    int width = (2 * height) - 1; is invalid because height is not a constant at compile time.

Local Variables: Local variables (inside functions) can be initialized using runtime values
since they are evaluated during the program execution.*/
int width = 9;
...
int main()
{
    ...
    // Call the function to print patterns for each character in the string
